...
allowtag = Table(
    ...
    default_fkey(['tagid'], ['searchtag.tagid'], name='allowtag_tagid_fkey'),
    default_fkey(['userid'], ['login.userid'], name='allowtag_userid_fkey'),
)

Index('ind_allowtag_userid', allowtag.c.userid)
...
fursona = Table(
    ...
    default_fkey(['userid'], ['login.userid'], name='fursona_userid_fkey'),
)

Index('ind_fursona_userid', fursona.c.userid)
...
login = Table(
    ...
    Column('passhash', String(length=40), nullable=False),
...
loginverify = Table(
    'loginverify', metadata,
    Column('verifyid', String(length=100), primary_key=True, nullable=False),
    Column('unixtime', WeasylTimestampColumn(), nullable=False),
    Column('username', String(length=40), nullable=False),
    Column('login_name', String(length=40), nullable=False, unique=True),
    Column('salt', String(length=40), nullable=False),
...
report = Table(
    ...
    Column('closerid', Integer(), nullable=False, server_default='0'),
    Column('settings', String(length=20), nullable=False, server_default=''),
)
...
searchmapchar = Table(
    ...
    Column('targetid', Integer(), primary_key=True, nullable=False),
    Column('settings', String(), nullable=False, server_default=''),
    default_fkey(['targetid'], ['fursona.charid'], name='searchmapchar_targetid_fkey'),
...
shout = Table(
    ...
    Column('indent', Integer(), nullable=False, server_default='0'),
    Column('settings', String(length=20), nullable=False, server_default=''),
    default_fkey(['userid'], ['login.userid'], name='shout_userid_fkey'),
)

Index('ind_shout_settings', shout.c.settings)
Index('ind_shout_targetid_settings', shout.c.targetid, shout.c.settings)
Index('ind_shout_targetid', shout.c.targetid)
...
submission = Table(
    'submission', metadata,
    Column('submitid', Integer(), primary_key=True, nullable=False),
    Column('folderid', Integer(), nullable=False),
    Column('userid', Integer()),
    Column('unixtime', WeasylTimestampColumn(), nullable=False),
    Column('title', String(length=200), nullable=False),
    Column('content', Text(), nullable=False),
    ...
    Column('page_views', Integer(), nullable=False, server_default='0'),
    Column('sorttime', Integer(), nullable=False),
...
submitcomment = Table(
    ...
    Column('indent', Integer(), nullable=False, server_default='0'),
    Column('settings', String(length=20), nullable=False, server_default=''),
    default_fkey(['userid'], ['login.userid'], name='submitcomment_userid_fkey'),
    default_fkey(['targetid'], ['submission.submitid'], name='submitcomment_targetid_fkey'),
)

Index('ind_submitcomment_targetid', submitcomment.c.targetid)
...
userinfo = Table(
    ...
    Column('aim', String(length=100), nullable=False, server_default=''),
    Column('yahoo', String(length=100), nullable=False, server_default=''),
    Column('msn', String(length=100), nullable=False, server_default=''),
    Column('skype', String(length=100), nullable=False, server_default=''),
    Column('icq', String(length=100), nullable=False, server_default=''),
    Column('twitter', String(length=100), nullable=False, server_default=''),
    Column('tumblr', String(length=100), nullable=False, server_default=''),
    Column('facebook', String(length=100), nullable=False, server_default=''),
    Column('googleplus', String(length=100), nullable=False, server_default=''),
    Column('steam', String(length=100), nullable=False, server_default=''),
    Column('xboxlive', String(length=100), nullable=False, server_default=''),
    Column('psn', String(length=100), nullable=False, server_default=''),
    Column('foursquare', String(length=100), nullable=False, server_default=''),
    Column('myspace', String(length=100), nullable=False, server_default=''),
    Column('reddit', String(length=100), nullable=False, server_default=''),
    Column('youtube', String(length=100), nullable=False, server_default=''),
...
userstats = Table(
    ...
    Column('fursonas', Integer(), nullable=False, server_default='0'),
...
Index('ind_welcome_userid', welcome.c.userid)

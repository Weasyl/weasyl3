# -*- coding: utf-8 -*-
#
# Weasyl 3 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Weasyl3.tex', u'Weasyl 3 Documentation',
   u'Weasyl LLC', 'manual'),
]
...
man_pages = [
    ('index', 'weasyl3', u'Weasyl 3 Documentation',
     [u'Weasyl LLC'], 1)
]
...
texinfo_documents = [
  ('index', 'Weasyl3', u'Weasyl 3 Documentation',
   u'Weasyl LLC', 'Weasyl3', 'One line description of project.',
   'Miscellaneous'),
]
